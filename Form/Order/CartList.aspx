...
<%} else { %>
	<p class="no_cart_">カートに商品がありません。</p>
<%} %>
...
<% } %>
  ...
  <h4 visible='<%# ((CartObject)Container.DataItem).ShippingType == "100" %>' runat="server">通常商品<span>※次のご注文画面にて複数のお届け先へ分割できます</span></h4>
  <h4 visible='<%# ((CartObject)Container.DataItem).ShippingType == "1001" %>' runat="server">予約商品<span>※次のご注文画面にて複数のお届け先へ分割できます</span></h4>
