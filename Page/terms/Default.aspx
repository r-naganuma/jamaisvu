    ...
    <div class="privacyBox__contents">
      ...
      <ul class="privacyBox__contents__parts">
        <li>
          ...
          <p>本規約は､当社が提供する本サービスの利用に関する規約を定めたものです。当社と利用者（第2条で定義します）との間の事項のすべてにわたり適用されるものとします。<br><br>当社は､利用者の承諾なしに本規約に新たな規定を追加および変更できるものとします。利用者は､当社からのオンラインあるいはその他の方法で提示される運用規定またはその他の諸規定の追加および変更を承諾するものとし、またそれは本規約の一部を構成するものとします。 商品購入に関する事項（申込み、決済方法その他）については、第10条に定めるところによるものとします。</p>
