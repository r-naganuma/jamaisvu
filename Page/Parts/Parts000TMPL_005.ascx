...
<div class="mainVisualRev">
	...
	<div class="mainVisualRev_slide">
	    <div class="mainVisualRev_main">
	        <img class="pc_contents" src="<%= Constants.PATH_ROOT %>Contents/ImagesPkg/user/top/mv_main05.jpg" alt="">
	        <img class="sp_contents" src="<%= Constants.PATH_ROOT %>Contents/ImagesPkg/user/top/mv_sp05.jpg" alt="">
	    </div>
	    <div class="mainVisualRev_sub pc_contents">
	        <img src="<%= Constants.PATH_ROOT %>Contents/ImagesPkg/user/top/mv_sub05.jpg" alt="">
	    </div>
	</div>
</div>
<%-- △編集可能領域△ --%>
