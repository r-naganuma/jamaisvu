...
<div class="featureWrap topicsWrap feature">
  <div class="mainArea">
    <h2>お盆期間の営業に関するお知らせ</h2>

    <p>
      平素よりJAMAIS VU公式ブランドサイトをご利用いただき、誠にありがとうございます。<br>
      誠に勝手ながら以下お盆期間を休業とさせていただきます。<br>
  ...
  <div class="ctsList">
    ...
    <p class="ctsList_txt">
      2020年8月12日(水)午前11時59分までのご注文→当日中に発送させていただきます。<br>
      2020年8月12日(水)午後12時以降のご注文→2020年8月17日(月)以降に順次発送させていただきます。
    </p>
  </div>
  ...
  <div class="ctsList">
    ...
    <p class="ctsList_txt">
      2020年8月12日(水)午後18時以降にいただいたお問い合わせ（ご質問・返品・交換等）につきましては、<br class="pc_contents">2020年8月17日(月)以降に順次ご返信をさせていただきます。
    </p>
  </div>
