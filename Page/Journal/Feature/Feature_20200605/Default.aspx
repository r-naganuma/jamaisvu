...
<div class="journalWrap">
    <div class="journalWrap_cts">
        ...
        <div class="mainArea">
            ...
            <div class="mainArea_ttl">
                ...
                <ul class="mainArea_ttl--sns">
                    ...
                    <li>
                        <a href="http://twitter.com/share?url=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200605/&text=モデル、Kanocoさんが伝える“私らしいスタイル”vol.5" target="_blank">
                            <img src="../../images/common/icn_tw.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200605/" target="_blank">
        ...
        <div class="ctsArea">
            ...
            <div class="A-wrap">
                <p class="A-wrap_ttl">
                    素材とシルエットで魅せる<br class="sp_contents">爽やかなオールブラック
                </p>
                <img class="A-wrap_pic" src="images/pic_a_01.jpg" alt="">
                <p class="A-wrap_txt">
                    モノトーンスタイルは私の定番です。心地よくフィットするトップスは、細見えするところも気に入りました。風が吹くとふわりと広がるラップスカートを合わせて、スニーカーでカジュアルダウン。ちょっと近寄りがたく見えてしまうので、全身黒のときはモードになりすぎないように気をつけています。今日はアイテムごとに素材を変えて、軽やかに見えるように仕上げました。
                </p>
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010315119&cat=500019" class="A-wrap_detail--box">
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010315119&cat=500019" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=1930632117&cat=500017" class="A-wrap_detail--box">
                        <div class="A-wrap_detail--box--pic">
                            <img src="images/item_02.jpg" alt="">
                        </div>
                        <div class="A-wrap_detail--box--txt">
                            <p class="detailTtl">フリーサイズラップ</p>
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=1930632117&cat=500017" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
            </div>
                ...
                <div class="F-wrap_box">
                    <div class="F-wrap_box--main">
                        ...
                        <p class="F-wrap_box--txt pc_contents">
                            <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010315119&cat=500019">ICE COTTON リブカーディガン¥15,400(tax in)</a><br>
                            <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=1930632117&cat=500017">フリーサイズラップ¥20,900(tax in)</a><br>
                            帽子、バッグ、シューズ(モデル私物)
                        </p>
                    </div>
                ...
                <div class="latestArea_box">
                    ...
                    <div class="latestArea_box--list">
                        <a href="<%= Constants.PATH_ROOT %>Page/Journal/Feature/Feature_20200602">
                            <img src="images/archive04_pc.jpg" class="pc_contents" alt="">
                            <img src="images/archive04_sp.jpg" class="sp_contents" alt="">
                            <p class="archiveTtl">
