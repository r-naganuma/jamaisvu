        ...
        <div class="ctsArea">
            ...
            <div class="A-wrap">
                ...
                <p class="E-wrap_txt">
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010321151&cat=500051">SUVIN半袖ニットスウェット ¥19,800(tax in)</a>
                </p>
                <p class="A-wrap_txt">
            ...
            <div class="A-wrap">
                ...
                <p class="A-wrap_txt">
                    新モデルのシャツワンピースは、羽織にもなる前開きのデザイン。サイドの大きなポケットがカジュアル感を醸しています。そではカフス仕立てで、長さが簡単に調整可能。インナーしだいでバランスが変えられるのも高ポイントです。<br>
                    <br>
                    Style01ではネイビーを合わせましたが、定番色の黒を合わせるなら…と考えたのがこのコーディネートです。シャツワンピースの色が淡いから、黒の分量が多いと負けてしまいそう。そこで合わせるアイテムをモノトーンの柄ものにし、少しずつ黒を足していくことで、辛口なムードにもっていきました。ストライプのゆったりパンツ、バンダナ柄のシルクスカーフ、ギンガムチェックのメルカドバッグ…。柄×柄×柄の高度な組み合わせですが、モノトーンなら違和感なし。シャツワンピースのライトグリーンが活きつつも、どこかモードな雰囲気もある着こなしです。
                </p>
            </div>
            ...
            <div class="A-wrap">
                ...
                <p class="A-wrap_txt">
                    ...
                    <br>
                    今回はややワイドなシルエットのパンツでしたが、基本的にボトムは選びません。五分に近い袖の長さは、気になる二の腕をカバーしてくれる役割も。身ごろも適度なゆとりがあるので、リラックス感のある一枚です。
                </p>
                <div class="A-wrap_detail">
