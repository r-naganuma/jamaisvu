...
<div class="journalWrap">
    <div class="journalWrap_cts">
        ...
        <div class="mainArea">
            ...
            <div class="mainArea_ttl">
                ...
                <ul class="mainArea_ttl--sns">
                    ...
                    <li>
                        <a href="http://twitter.com/share?url=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200526/&text=モデル、Kanocoさんが伝える“私らしいスタイル”vol.2" target="_blank">
                            <img src="../../images/common/icn_tw.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200526/" target="_blank">
        ...
        <div class="ctsArea">
            ...
            <div class="A-wrap">
                <p class="A-wrap_ttl">
                    シンプルな中にこだわりを感じる<br class="sp_contents">ハンサムなスタイリング
                </p>
                <img class="A-wrap_pic" src="images/pic_a_01.jpg" alt="">
                <p class="A-wrap_txt">
                    着心地のいいカーキのスウェットニットを主役に、ユニセックスなスタイルに仕上げました。トップスをメンズのヴィンテージパンツにINしたら、ベルトでウエストをキュッと絞ってスタイルアップ。上下ともに無地なので、メガネで少しクセのあるニュアンスを表現しました。
                </p>
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010321159&cat=500059" class="A-wrap_detail--box">
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010321159&cat=500059" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
                <div class="A-wrap_detail">
                ...
                <div class="F-wrap_box">
                    <div class="F-wrap_box--main">
                        ...
                        <p class="F-wrap_box--txt pc_contents">
                            <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010321159&cat=500059">SUVIN半袖ニットスウェット¥14,300(tax in)</a>, <br><a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=1930731117&cat=500017">フリーサイズテーパード¥23,100(tax in)</a>
                        </p>
                    </div>
