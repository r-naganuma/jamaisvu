...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<%-- ▽編集可能領域：HEAD追加部分▽ --%>
<link href='../../css/common.css?12345' rel='stylesheet' type='text/css'>
<link href='css/common.css' rel='stylesheet' type='text/css'>
<link rel="stylesheet" href="https://use.typekit.net/rzu4tgs.css">
<meta name="viewport" content="width=device-width,initial-scale=1">
<%-- △編集可能領域△ --%>
...
<div class="journalWrap">
    <div class="journalWrap_cts">
        ...
        <div class="ctsArea">
            ...
            <div class="A-wrap">
                <p class="A-wrap_txt">
                    前回大好評だったモデルkanocoさんによる私服 X <br class="sp_contents">JAMAIS VU のミックススタイル。<br class="pc_contents">
                    今回は秋冬のニットと合わせながらkanocoさんのスタイルを作り上げる「MY RULE」<br class="pc_contents">
                    を2回に渡りお届けします。
                </p>
                <p class="A-wrap_ttl">
                    STYLE 01
            ...
            <div class="A-wrap">
                ...
                <p class="A-wrap_txt">
                    シンプルだけど、何かあるっていうものに惹かれます。<br class="sp_contents">このニットは、そんなところがすごくいいなって思いました。<br>
                    サイズ感もちょうどいい。このベレー帽もアイテム自体はベーシックなものだけど、ちょっと大きくて個性的。<br class="pc_contents">
                    髪を中に入れたりして。そして、そこにパールのピアスが自分的に重要なポイント。<br>
                    ちょっと個性があるものと普遍的なものを組み合わせるのが好きです。
                </p>
                <!-- item -->
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2031127111&cat=500011" class="A-wrap_detail--box">
                        <div class="A-wrap_detail--box--pic">
                            <img src="images/item_a_01.jpg" alt="">
                        </div>
                        <div class="A-wrap_detail--box--txt">
                            <p class="detailTtl">ハミルトン　ミドルゲージ<br class="sp_contents">プルオーバー</p>
                            <p class="detailPrice">¥20,900(tax in)</p>
                            <p class="detailTxt">
                                素材：メハミルトンラムズウール    サイズ：FREE <br>
                                カラー：ホワイト
                            </p>
                        </div>
                    </a>
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2031127111&cat=500011" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
                <!-- item -->
                ...
                <p class="A-wrap_txt">
                    ニットに合わせたのは、100年くらい前のヴィンテージ<br class="sp_contents">ワンピースなんです。<br class="pc_contents">
                    繊細なので大事に大事に着ています。<br class="pc_contents">
                    今のものと昔のもの。ニットの温かみのある白とコットンのピュアな白。<br>
            ...
            <div class="A-wrap">
                ...
                <p class="A-wrap_txt">
                    このワンピースもヴィンテージです。古着の花柄が大好きなんです。<br>
                    このコーディネートはなんと言ってもそれにハイテクスニーカーを合わせたところがポイント。<br>
                    古着とハイテク、いつの時代かわからないかんじが気に入っています。<br>
                    ほっこりし過ぎないようにしたいなと思って。<br>
                    なんとも言えないブラウンのざっくりしたニットがしっくり馴染みました。
                </p>
                <!-- item -->
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2031226149&cat=500049" class="A-wrap_detail--box">
                        <div class="A-wrap_detail--box--pic">
                            <img src="images/item_a_02.jpg" alt="">
                        </div>
                        <div class="A-wrap_detail--box--txt">
                            <p class="detailTtl">ハミルトン　ミドルゲージ　<br class="sp_contents">ビッグカーディガン</p>
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2031226149&cat=500049" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
                <!-- item -->
                <div class="sec__center">
                    <div>
                ...
                <p class="A-wrap_txt">
                    このニットもシンプルだけど、ありそうで無い色とか<br>
                    ロングワンピースにもバランス良く着られるサイズ感がいいなと思いました。<br>
    ...
    <div class="journalWrap_item">
        ...
        <ul>
            ...
            <li>
                <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2031226149&cat=500049">
                    <img src="images/item_a_02.jpg" alt="">
                    <p>
                        ハミルトン　ミドルゲージ<br>
                        ビッグカーディガン
        ...
        <a href="https://jamaisvu.co.jp/Form/Product/ProductList.aspx?shop=0&cat=&dpcnt=24&img=2&sort=07&swrd=%e3%83%8f%e3%83%9f%e3%83%ab%e3%83%88%e3%83%b3%e3%80%80%e3%83%9f%e3%83%89%e3%83%ab%e3%82%b2%e3%83%bc%e3%82%b8%e3%80%80%e3%83%97%e3%83%ab%e3%82%aa%e3%83%bc%e3%83%90%e3%83%bc&udns=0&fpfl=0&pno=1" class="journalWrap_item--btn">すべてのアイテムをみる</a>
    </div>
</div>
<%-- △編集可能領域△ --%>
