...
<div class="journalWrap">
    <div class="journalWrap_cts">
        ...
        <div class="mainArea">
            ...
            <div class="mainArea_ttl">
                ...
                <ul class="mainArea_ttl--sns">
                    ...
                    <li>
                        <a href="http://twitter.com/share?url=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200522/&text=モデル、Kanocoさんが伝える“私らしいスタイル”vol.1" target="_blank">
                            <img src="../../images/common/icn_tw.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://jamaisvu.co.jp/Page/Journal/Feature/Feature_20200522/" target="_blank">
        ...
        <div class="ctsArea">
            ...
            <div class="A-wrap">
                <p class="A-wrap_ttl">
                    風合い豊かなカフタンドレスで、<br class="sp_contents">透明感を引き出して
                </p>
                <img class="A-wrap_pic" src="images/pic_a_01.jpg" alt="">
                <p class="E-wrap_txt">
                    パンツ(モデル私物)、シューズ(モデル私物)
                </p>
                <p class="A-wrap_txt">
                    もともとマキシ丈のワンピースは大好き。<br class="sp_contents">特にこの色は相性がよかったのか、着たとき肌が明るくなるのを感じました。淡い色合いなので、ドット柄の黒いパンツで締めつつ、足元にレディライクなバレエシューズを。凛としたクールな雰囲気に柔らかなニュアンスを添えました。
                </p>
                <div class="A-wrap_detail">
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010552143&cat=500043" class="A-wrap_detail--box">
                    ...
                    <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010552143&cat=500043" class="A-wrap_detail--btn">ITEM DETAIL</a>
                </div>
            </div>
                ...
                <div class="F-wrap_box">
                    <div class="F-wrap_box--main">
                        ...
                        <p class="F-wrap_box--txt pc_contents">
                            <a href="https://jamaisvu.co.jp/Form/Product/ProductDetail.aspx?shop=0&pid=2010552143&cat=500043">ペルビアンピマコットンワンピース ¥19,800(tax in)</a>, <br>パンツ(モデル私物),シューズ(モデル私物)
                        </p>
                    </div>
            ...
            <div class="J-wrap">
                ...
                <div class="J-wrap_txt">
                    ...
                    <p class="J-wrap_txt--cts">
                        モデル。『リンネル』、『ONKUL』などをはじめとしたファッション誌を中心に広告やMVでも幅広く活躍中。<br>
                        ライフスタイル誌『OZmagazine』のカバーガールを務める。<br>
                        無類のシロクマ好き。
                    </p>
                </div>
            </div>
